...
--               /home/khanna/HBM/PCIe-HBM_basic-prj/vivado_gen/pcie-hbm_sim/pcie-hbm_sim.gen/sources_1/bd/qdma_hbm_bd/ip/qdma_hbm_bd_clk_wiz_0_0/qdma_hbm_bd_clk_wiz_0_0_sim_netlist.vhdl
...
entity qdma_hbm_bd_clk_wiz_0_0_clk_wiz is
  port (
...
end qdma_hbm_bd_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of qdma_hbm_bd_clk_wiz_0_0_clk_wiz is
  signal clk_in1_qdma_hbm_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_qdma_hbm_bd_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_qdma_hbm_bd_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_qdma_hbm_bd_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_qdma_hbm_bd_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_qdma_hbm_bd_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity qdma_hbm_bd_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    resetn : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of qdma_hbm_bd_clk_wiz_0_0 : entity is true;
end qdma_hbm_bd_clk_wiz_0_0;

architecture STRUCTURE of qdma_hbm_bd_clk_wiz_0_0 is
begin
inst: entity work.qdma_hbm_bd_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
