...
HD_PWD='/home/khanna/HBM/PCIe-HBM_basic-prj/vivado_gen/pcie-hbm_sim/pcie-hbm_sim.runs/qdma_hbm_bd_smartconnect_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qdma_hbm_bd_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qdma_hbm_bd_smartconnect_0_0.tcl
